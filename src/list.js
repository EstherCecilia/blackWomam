...
import marielle from "./images/marielle.jpg";
  ...
  return (
    <div className={classes.rot}>
      ...
      <div className={classes.div}>
        <img className={classes.img} src={daniela} />
        <span className={classes.span}>
          Eu tenho carregado esse peso E o mundo debaixo dessas tranças E estou
          confusa Você aceitaria a dor que veio Com todas as partes que você
          quer reivindicar para você
        </span>
      </div>
      <div className={classes.div}>
        <span className={classes.span}>
          Falar de raça é falar da dominação e escravização de um povo, do
          apagamento, silenciamento e retirada da sua humanidade. Falar sobre
          raça é falar sobre a desigualdade que estrutura a nossa sociedade até
          hoje. Marielle Franco
        </span>{" "}
        <img className={classes.img} src={marielle} />
      </div>
    </div>
  );
}
